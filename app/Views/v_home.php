    ...
    <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="https://lh3.googleusercontent.com/p/AF1QipPwJsW96xjyMPZkJWp9Niaim4RAz6B9tffU4iF5=s680-w680-h510" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block">
                    <h3><b>Selamat Datang di Website Masjid Al-Ikhlas</b></h3>
                    <p>Semua yang berkaitan dengan Masjid Al-Ikhlas tersedia di Website ini</p>
                </div>
            </div>
            <div class="carousel-item">
                <img src="https://lh3.googleusercontent.com/p/AF1QipO_eJkjHAUxp01VKFm0EYGGsUNq1Ftq97XfN8Tt=s680-w680-h510" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block">
                    <h3><b>Jadwal Sholat</b></h3>
                    <p>Kini Anda dapat melihat jadwal lengkap pelaksanaan Ibadah Sholat disini</p>
                </div>
            </div>
            <div class="carousel-item">
                <img src="https://lh3.googleusercontent.com/p/AF1QipMKoOiQrjAN847rGs9VL8NCyoe5oApqgYHmaPcx=s680-w680-h510" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block">
                    <h3><b>Info dan Agenda Kegiatan</b></h3>
            ...
            <ul class="products-list product-list-in-card pl-2 pr-2">
                <li class="item">
                    ...
                    <div class="product-info">
                        ...
                        <span class="product-description"><?= $waktu['data']['jadwal']['imsak'] ?></span>
                    </div>
                </li>
                <li class="item">
                    <div class="product-img">
                    ...
                    <div class="product-info">
                        ...
                        <span class="product-description"><?= $waktu['data']['jadwal']['subuh'] ?></span>
                    </div>
                </li>
                <li class="item">
                    <div class="product-img">
                    ...
                    <div class="product-info">
                        ...
                        <span class="product-description"><?= $waktu['data']['jadwal']['dhuha'] ?></span>
                    </div>
                </li>
                <li class="item">
                    <div class="product-img">
                    ...
                    <div class="product-info">
                        ...
                        <span class="product-description"><?= $waktu['data']['jadwal']['dzuhur'] ?></span>
                    </div>
                </li>
                <li class="item">
                    <div class="product-img">
                    ...
                    <div class="product-info">
                        ...
                        <span class="product-description"><?= $waktu['data']['jadwal']['ashar'] ?></span>
                    </div>
                </li>
                <li class="item">
                    <div class="product-img">
                    ...
                    <div class="product-info">
                        ...
                        <span class="product-description"><?= $waktu['data']['jadwal']['maghrib'] ?></span>
                    </div>
                </li>
                <li class="item">
                    <div class="product-img">
                    ...
                    <div class="product-info">
                        ...
                        <span class="product-description"><?= $waktu['data']['jadwal']['isya'] ?></span>
                    </div>
                </li>
            </ul>
        ...
        <div class="col-md-6">
            <div class="info-box">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number">Rp. <?= number_format($saldo_m, 0) ?></span>
                </div>
                <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
